...
| 8   | **Отсутствие RBAC (role-based access control)**           | Нет гибкой системы разграничения доступа к данным и функциональности в зависимости от роли пользователя.      | Угрозы безопасности, невозможность делегировать доступ по принципу наименьших привилегий, рост рисков при масштабировании. |
